...
export function Modal(props: ModalProps) {
  ...
  return (
    <Overlay portalContainer={document.body}>
      ...
      >
        <div
          className="fixed inset-x-0 top-16 bottom-0 flex justify-center z-100 bg-black/50"
          {...underlayProps}
        >
          <CSSTransition
            in={state.isOpen}
          ...
          >
            <div
              {...modalProps}
              ref={ref}
              className={clsx("fixed inset-x-0 top-0 transition-all", {
                "h-5/6 bg-white shadow-lg": state.isOpen,
              })}
